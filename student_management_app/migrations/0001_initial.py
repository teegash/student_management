# Generated by Django 5.0.1 on 2024-01-31 13:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("address", models.TextField()),
                ("session_start_year", models.DateField(default=datetime.date.today)),
                ("session_end_year", models.DateField(default=datetime.date.today)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now_add=True)),
                (
                    "admin",
